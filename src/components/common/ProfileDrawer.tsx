...
import { X, LogIn, UserPlus, Sparkles, User, Download } from "lucide-react";
import Link from 'next/link';
import { useAuth } from '@/context/AuthContext'; // Import the auth hook
import QRGenerator from "@/components/common/RegistreationQrCode";
import QRModal from "@/components/common/QrModal";
const RightSideDrawer = ({ data }: { data: any }) => {
                            ...
                            <div className="flex-1 p-5 space-y-4 overflow-y-auto">
                                ...
                                {data?.photo && (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-col">
                                                <span className="font-semibold">DOWNLOAD PHOTO</span>
                                                <span className="text-xs text-gray-500">Click to download</span>
                                            </div>
                                        </a>
                                    </motion.div>
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        {['Share Candidate Profile'].map((item, index) => (
                                            <motion.div
                                                key={item}
                                                whileHover={{ x: 5 }}
