...
export default function UserEditForm() {
    ...
    // For a route: /admin/users/update/[id]
            ...
            >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 ">
                            ...
                            <div className="col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select {...register('maritalStatus')} className="w-full px-4 py-3 border rounded-lg bg-white dark:bg-gray-800 dark:text-white text-sm focus:ring-2 focus:ring-orange-500">
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label className="dark:bg-gray-800 dark:text-white flex items-center space-x-2 p-3 rounded-lg border border-gray-200  dark:hover:bg-gray-500 hover:bg-gray-400  cursor-pointer">
                                <input type="checkbox" {...register('hasPreviousInterview')} className="rounded text-blue-600 focus:ring-blue-500" />
                                <span>Has Previous Interview</span>
                            </label>
                            <label className="dark:bg-gray-800 dark:text-white flex items-center space-x-2 p-3 rounded-lg border border-gray-200  dark:hover:bg-gray-500 hover:bg-gray-400  cursor-pointer">
                                <input type="checkbox" {...register('isDifferentlyAbled')} className="rounded text-blue-600 focus:ring-blue-500" />
                                <span>Differently Abled</span>
                            </label>
                            <label className="dark:bg-gray-800 dark:text-white flex items-center space-x-2 p-3 rounded-lg border border-gray-200 dark:hover:bg-gray-500 hover:bg-gray-400  cursor-pointer">
                                <input type="checkbox" {...register('hasPoliceRecord')} className="rounded text-blue-600 focus:ring-blue-500" />
                                <span>Has Police Record</span>
                            </label>
                            <label className="dark:bg-gray-800 dark:text-white flex items-center space-x-2 p-3 rounded-lg border border-gray-200 dark:hover:bg-gray-500 hover:bg-gray-400  cursor-pointer">
                                <input type="checkbox" {...register('hasMajorIllness')} className="rounded text-blue-600 focus:ring-blue-500" />
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
                            <div>
                                <label className=" dark:text-white block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Recruiter Name</label>
                                <input
                                ...
                                )}
                            {
                                user?.role !== "lead" && (
                                    <label className="flex items-center">
                                        ...
                                        <span className="ml-2 text-red-800 dark:text-red-300">Verify Member

                                        </span>
                                        <small className='ml-2 text-red-800 dark:text-red-100'>(If all details have been verified and approved by the authorized panel, the profile will be locked and marked as “Checked.” Once a profile is marked as Checked, users will no longer be able to edit or update their information. )</small>
                                    </label>
                                )
                            }
