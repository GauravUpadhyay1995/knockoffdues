...
export default function ReminderDropdown({ isOpen, onClose }: NotificationDropdownProps) {
    ...
    const now = dayjs().toDate(); // current date-time
                            ...
                            {notifications.map((notification, index) => (
                                ...
                                >
                                    <div className="flex items-start space-x-3">
                                        {/* Icon */}
                                        <div className={`flex-shrink-0 w-10 h-10 rounded-full border-2 flex items-center justify-center text-lg `}>
                                            {getNotificationIcon("other")}
                                        </div>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center space-x-1 text-xs text-gray-500 dark:text-gray-300">
                                                    ...
                                                    <span>{formatTimestamp(notification.reminderTime)}</span>
