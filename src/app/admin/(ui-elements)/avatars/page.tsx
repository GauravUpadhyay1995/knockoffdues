...
export const metadata: Metadata = {
  title: "Next.js Avatars | Knock Off Dues - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Knock Off Dues - Next.js Tailwind CSS Admin Dashboard Template",
};
