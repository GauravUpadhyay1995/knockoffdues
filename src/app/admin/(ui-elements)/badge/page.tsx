...
export const metadata: Metadata = {
  title: "Next.js Badge | Knock Off Dues - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Knock Off Dues - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
