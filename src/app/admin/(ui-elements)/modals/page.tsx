...
export const metadata: Metadata = {
  title: "Next.js Modals | Knock Off Dues - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Knock Off Dues - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
