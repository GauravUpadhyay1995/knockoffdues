  ...
  const sections = [
    {
      title: "Introduction",
      content:
        "At Knock Off Dues, we are committed to protecting the personal data of our users, customers, and partners. This Privacy and Security Policy outlines how we collect, use, store, and safeguard your information in compliance with applicable laws.",
    },
    {
      title: "Scope",
      content:
        "This policy applies to all data collected and processed through Knock Off Dues's platform, including mobile apps, websites, customer support systems, and any third-party integrations.",
    },
    {
    ...
    },
    {
      ...
      list: [
        ...
        "To exercise your rights, contact: privacy@Knock Off Dues.in",
      ],
    },
    {
