export const BULK_TEMPLATE = `<div style="font-family: 'Segoe UI', Tahoma, sans-serif; color: #333; line-height: 1.6; margin: auto; border: 1px solid #ddd; border-radius: 10px; overflow: hidden;">
  ...
  <div style="background-color: #fff; padding: 30px;">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="#"style="background-color: #004aad; color: white; padding: 12px 25px; border-radius: 6px; text-decoration: none; font-weight: 500;">
        {#OTPCode}
      </a>
    </div>
